...
const AUTH0_CLIENT_ID = '6FX0ozCcpxfnEDIarDoO4ds4GcaMzJcH';
const AUTH0_DOMAIN = 'ale-rojas.auth0.com';
const AUTH0_CALLBACK_URL = window.location.href; // eslint-disable-line
const PUBLIC_ENDPOINT = 'https://rncl14zat6.execute-api.us-east-1.amazonaws.com/dev/api/public';
const PRIVATE_ENDPOINT = 'https://rncl14zat6.execute-api.us-east-1.amazonaws.com/dev/api/private';
